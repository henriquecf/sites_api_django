...
class NewsAPITestCase(APILiveServerTestCase):
    ...
    def test_slug_is_slugified_title(self):
        publication_routines.slug_is_slugified_title_routine(self)

    def test_slug_is_unique(self):
        publication_routines.slug_is_unique_routine(self)

    def test_has_author(self):
        publication_routines.has_author_routine(self)

    def test_is_published_default_true(self):
        publication_routines.is_published_default_true_routine(self)

    def test_publish(self):
        publication_routines.publish_routine(self)

    def test_unpublish(self):
        publication_routines.unpublish_routine(self)
